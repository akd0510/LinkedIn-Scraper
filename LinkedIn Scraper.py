...
def linkedin():
    ...
    time.sleep(1)
    user_id = driver.find_element_by_id("username").send_keys("akki0510@gmail.com")
    time.sleep(1)
    ...
    filters = 'site:Linkedin.com "TCS" AND "India" AND "@gmail.com"'
    ...
    for page in range(page_no):
        ...
        search_mail = driver.find_elements_by_class_name('IsZvec')
        google_page = driver.page_source
        source_page = BeautifulSoup(google_page,'lxml')
        google_links = source_page.find_all('div',{'class':'yuRUbf'})
